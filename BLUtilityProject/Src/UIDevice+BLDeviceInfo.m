...
#import "UIDevice+BLDeviceInfo.h"

#import "sys/utsname.h"

@implementation UIDevice (BLDeviceInfo)
...
+ (NSString *)modelName{
    ...
    if ([platform isEqualToString:@"iPad7,1"])   return @"iPad Pro 2G (12.9-inch) (A1670)";
    if ([platform isEqualToString:@"iPad7,2"])   return @"iPad Pro 2G (12.9-inch) (A1671/A1821)";
...
+ (NSString *)shortModelName{
    ...
    if ([platform isEqualToString:@"iPad7,1"])   return @"iPad Pro 2G (12.9-inch)";
    if ([platform isEqualToString:@"iPad7,2"])   return @"iPad Pro 2G (12.9-inch)";
